...
const { getTunnel, readMap, home } = require('./state')
const { translate } = require('./messages')
const { isInstalled, tunnelExists } = require('./cloudflared')
...
module.exports = { runChecks, installPlan, installCloudflared, isLoggedIn }
